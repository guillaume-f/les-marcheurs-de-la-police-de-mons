...
export interface ApiBasepageBasepage extends Struct.CollectionTypeSchema {
  collectionName: 'basepages';
  info: {
    displayName: 'Page de base';
    pluralName: 'basepages';
    singularName: 'basepage';
  };
  options: {
...
export interface ApiCommitteeCommittee extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Membres: Schema.Attribute.Component<'comite.membre-du-comite', true>;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::basepage.basepage': ApiBasepageBasepage;
